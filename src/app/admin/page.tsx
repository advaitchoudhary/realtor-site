                ...
                filtered.map((inq) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mt-1.5">
                      <span className="text-xs text-[var(--primary)] font-medium">{TYPE_LABELS[inq.type]}</span>
            ...
            <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
              <div className="p-6 border-b border-gray-100 flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">{timeAgo(selected.createdAt)} · {TYPE_LABELS[selected.type]} inquiry</p>
                </div>
...
function getDemoInquiries(): Inquiry[] {
  return [
    { id: "demo-1", name: "Sarah Thompson", email: "sarah.t@email.com", phone: "(416) 555-0142", message: "Hi, I'm very interested in the 3-bedroom detached home I saw on your website. Could we schedule a viewing this weekend?", listingAddress: "107 King St, Toronto, ON", listingPrice: 1125000, type: "listing", status: "new", createdAt: new Date(Date.now() - 3600000).toISOString() },
    { id: "demo-2", name: "Michael Chen", email: "mchen@gmail.com", phone: "(905) 555-0198", message: "Looking to buy in Mississauga, budget around $800K-1M. Need 4 beds minimum, good schools nearby.", type: "buyer", status: "contacted", createdAt: new Date(Date.now() - 86400000).toISOString(), notes: "Very motivated buyer, pre-approved at $950K." },
    { id: "demo-3", name: "Priya & Raj Mehta", email: "mehta.family@email.com", phone: "(647) 555-0213", message: "We would like to know the value of our home at 22 Maple Drive, Oakville before listing it.", type: "valuation", status: "new", createdAt: new Date(Date.now() - 7200000).toISOString() },
    { id: "demo-4", name: "David Kowalski", email: "david.k@outlook.com", phone: "", message: "Just a general inquiry — what neighbourhoods do you specialize in?", type: "general", status: "closed", createdAt: new Date(Date.now() - 3 * 86400000).toISOString(), notes: "Referred to Bloor West listings." },
    { id: "demo-5", name: "Linda Hoffmann", email: "lhoffmann@yahoo.com", phone: "(416) 555-0077", message: "Interested in the condo listing on Bay St. What are the maintenance fees and is parking included?", listingAddress: "821 Bay St, Toronto, ON", listingPrice: 649000, type: "listing", status: "new", createdAt: new Date(Date.now() - 1800000).toISOString() },
  ];
}
